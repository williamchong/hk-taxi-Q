...
under it; `P5-7` with its rule already written in `Q116`, broken down 2026-09-08 as `P5-7b`–`P5-7g` in that order — the grader before the code, config and fetch together, the cut as one commit with the game-side skip; `P5-9` last, because two regions can only
