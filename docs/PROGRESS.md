...
| `Q37` | **10.0% of the shipped façade survey is atlas filler, not a photograph** | 222 of 2,214 buildings render dead-neutral because they were not measured, and `Q34` then assigns them a material from absent data | `buildings.py`, survey | 🔴 Open. ⚠️ **The fix is structural** — enumerating filler colours has failed twice. ⚠️ The survey script was never committed, so this is reconstruct-and-revalidate. **Acceptance: 1,992 of 2,214 rows unchanged** |
