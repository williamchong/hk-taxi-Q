...
| `Q46` | **A grammar refusal draws a quiet tier, not invented fenestration** | Five drive-test sightings of invented windows and shopfronts on windowless stock | `P3-7a` | 🟡 Open — mechanism shipped (`W3`, five `quiet_*` tunables) and the `Q30` bar held (+1.10/+0.74/−0.04); awaiting the user's verdict on the `A⁗` frames in `build/driver/q26_A4_ab98183/` |
**Closed:** `Q1` `Q2` `Q3` `Q4` `Q5` `Q7` `Q8` `Q9` `Q10` `Q11` `Q12` `Q16` `Q17` `Q18` `Q20` `Q23`
`Q25` `Q27` `Q28` `Q29` `Q32` `Q33` `Q34` `Q34′` `Q36` `Q37` `Q40` `Q41` `Q43` `Q44` `Q45`. Each has a record in `DECISIONS.md`.
