...
- `P3-50` ⬜ Penalties (the user's ask, 2026-09-25) — a negative award docks the tip, `CRASH` first; the receipt, the flash (`accent_negative`) and the zero floor (`FareSystem.tip_of`) are built and checked; the detector and its bar are the task. Plan in `PLAN.md`.
