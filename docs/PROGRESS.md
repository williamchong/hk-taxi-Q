...
finding underneath it belongs to `Q31`'s owed rig pass. ⚠️ **A hillside split on an elevation
threshold was then specified, probed and refused** — high terrain renders 0.000% of all six fixed
viewpoints, and where a driver *can* see it, it is 97.5% flat paved terrace. Fourth "tint the class
before naming it".)
