...
| `scripts/city/generated_{road_graph,road_surface,fares}.gd` | Locators — one definition per document, two readers. `generated_fares.gd` is the one place that knows that document's shape |
