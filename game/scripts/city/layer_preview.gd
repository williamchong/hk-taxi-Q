...
## tramway as one mesh; the road marks, the boxes and the crossings as a mesh
## per plan cell, so the engine can cull what was 72,356 + 20,642 triangles
## from anywhere (`P3-40`, `P3-42`, `Q135`); the
